...
export default class Goal extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IGoal): void {
  ...
  public removeGoal(): void {
    this.goalService()
      ...
      .then(() => {
        const message = this.$t('goalTrackerApp.goal.deleted', { param: this.removeId });
