...
/**
 * REST controller for managing {@link io.rad.goaltrack.domain.Person}.
 */
@RestController
@RequestMapping("/api")
public class PersonResource {
    ...
    public ResponseEntity<Person> updatePerson(@PathVariable(value = "id", required = false) final String id, @RequestBody Person person)
    ...
    public ResponseEntity<Person> partialUpdatePerson(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, person.getId()));
    }
